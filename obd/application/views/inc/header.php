...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/plugins/grid-gallery/css/grid-gallery.min.css">
                        ...
                        <div class="col-lg-6 d-none d-lg-block">
                            <ul class="ulleft">
                                <li>
                                    ...
                                    mdzac96@gmail.com.com
                                    <span>|</span></li>
                                <li>
                                    <i class="far fa-clock"></i>
                                    Service Time : 12:00 AM</li>
                            </ul>
                        </div>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a class="nav-link" href="<?=base_url()?>process">Process</a>
                                        </li>
